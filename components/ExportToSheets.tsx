...
const DRETableHTML = ({ dre, title, remuneracaoHorariaLiquida, totalMonthlyHours }: { dre: any, title: string, remuneracaoHorariaLiquida?: number, totalMonthlyHours?: number }) => {
    ...
    const renderDetails = (details) => {
        ...
        return details.map(item => {
            ...
            // Always rendered expanded in the report using visual hierarchy (divs) instead of details/summary
    ...
    rows.forEach(item => {
        ...
        if (item.details) {
            // Always visible by default in report
